...
const DPGenerator = ({
  ...
  return (
    <>
      ...
      <div className=' mt-[64px] border shadow-md w-[500px] h-[93px] lg:h-[120px] lg:w-[1000px]'>
        <button
          onClick={handleDownload}
          className=" mt-[18px] mx-5 p-3 w-[540px] lg:w-[950px] rounded-[12px] bg-gradient-to-b from-[#198A4D] to-[#00C1FE] text-white"
        >
          Download Image
        </button>
      </div>
